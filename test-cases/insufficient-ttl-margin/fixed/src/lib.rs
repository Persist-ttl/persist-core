//! Fixed example for `insufficient-ttl-margin`: the entry is extended by a
//! generous margin (roughly a month of ledgers), so a missed call cycle or
//! two won't archive it.
#![no_std]
